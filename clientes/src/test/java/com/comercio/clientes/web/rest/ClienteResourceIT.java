...
import com.comercio.clientes.service.mapper.ClienteMapper;
...
class ClienteResourceIT {
    ...
    private static final TipoDocumento DEFAULT_TIPO_DCOUMENTO = TipoDocumento.CC;
    private static final TipoDocumento UPDATED_TIPO_DCOUMENTO = TipoDocumento.NIT;
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente()
            ...
            .tipoDcoumento(DEFAULT_TIPO_DCOUMENTO)
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente()
            ...
            .tipoDcoumento(UPDATED_TIPO_DCOUMENTO)
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getTipoDcoumento()).isEqualTo(DEFAULT_TIPO_DCOUMENTO);
        assertThat(testCliente.getNumDocumento()).isEqualTo(DEFAULT_NUM_DOCUMENTO);
        assertThat(testCliente.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testCliente.getNumTelefono()).isEqualTo(DEFAULT_NUM_TELEFONO);
    }
    ...
    @Test
    @Transactional
    void checkTipoDcoumentoIsRequired() throws Exception {
        int databaseSizeBeforeTest = clienteRepository.findAll().size();
        // set the field null
        cliente.setTipoDcoumento(null);
    ...
    @Test
    @Transactional
    void checkNumTelefonoIsRequired() throws Exception {
        int databaseSizeBeforeTest = clienteRepository.findAll().size();
        // set the field null
        cliente.setNumTelefono(null);
    ...
    void getAllClientes() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.[*].tipoDcoumento").value(hasItem(DEFAULT_TIPO_DCOUMENTO.toString())))
            .andExpect(jsonPath("$.[*].numDocumento").value(hasItem(DEFAULT_NUM_DOCUMENTO)))
            .andExpect(jsonPath("$.[*].email").value(hasItem(DEFAULT_EMAIL)))
            .andExpect(jsonPath("$.[*].numTelefono").value(hasItem(DEFAULT_NUM_TELEFONO)));
    }
    ...
    void getCliente() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.tipoDcoumento").value(DEFAULT_TIPO_DCOUMENTO.toString()))
            .andExpect(jsonPath("$.numDocumento").value(DEFAULT_NUM_DOCUMENTO))
            .andExpect(jsonPath("$.email").value(DEFAULT_EMAIL))
            .andExpect(jsonPath("$.numTelefono").value(DEFAULT_NUM_TELEFONO));
    }
    ...
    void putNewCliente() throws Exception {
        ...
        assertThat(testCliente.getTipoDcoumento()).isEqualTo(UPDATED_TIPO_DCOUMENTO);
        assertThat(testCliente.getNumDocumento()).isEqualTo(UPDATED_NUM_DOCUMENTO);
        assertThat(testCliente.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testCliente.getNumTelefono()).isEqualTo(UPDATED_NUM_TELEFONO);
    }
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.numDocumento(UPDATED_NUM_DOCUMENTO);
