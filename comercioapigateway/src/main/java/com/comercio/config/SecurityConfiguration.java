...
import com.comercio.security.jwt.JWTFilter;
import com.comercio.security.jwt.TokenProvider;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/api/admin/**").permitAll()// //.hasAuthority(AuthoritiesConstants.ADMIN)
            ...
            .pathMatchers("/management/**").permitAll();//hasAuthority(AuthoritiesConstants.ADMIN);
        // @formatter:on
        return http.build();
    }
}
