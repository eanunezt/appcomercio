...
describe('ItemOrden Management Component', () => {
  let comp: ItemOrdenComponent;
  let fixture: ComponentFixture<ItemOrdenComponent>;
  let service: ItemOrdenService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'item-orden', component: ItemOrdenComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ItemOrdenComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.itemOrdens?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
