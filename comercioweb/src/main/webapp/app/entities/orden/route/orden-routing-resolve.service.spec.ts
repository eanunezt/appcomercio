...
describe('Orden routing resolve service', () => {
  ...
  let resultOrden: IOrden | undefined;
  ...
  describe('resolve', () => {
    it('should return IOrden returned by find', () => {
      ...
      expect(resultOrden).toEqual({ id: 123 });
    });

    it('should return new IOrden if id is not provided', () => {
      // GIVEN
      ...
      expect(resultOrden).toEqual(new Orden());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Orden })));
      mockActivatedRouteSnapshot.params = { id: 123 };
