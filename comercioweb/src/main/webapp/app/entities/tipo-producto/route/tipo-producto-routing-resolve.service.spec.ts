...
describe('TipoProducto routing resolve service', () => {
  ...
  let routingResolveService: TipoProductoRoutingResolveService;
  let service: TipoProductoService;
  let resultTipoProducto: ITipoProducto | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(TipoProductoRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new ITipoProducto if id is not provided', () => {
      // GIVEN
      ...
      expect(resultTipoProducto).toEqual(new TipoProducto());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as TipoProducto })));
      mockActivatedRouteSnapshot.params = { id: 123 };
