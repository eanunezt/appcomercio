...
describe('Transportador Management Component', () => {
  let comp: TransportadorComponent;
  let fixture: ComponentFixture<TransportadorComponent>;
  let service: TransportadorService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'transportador', component: TransportadorComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TransportadorComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transportadors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
